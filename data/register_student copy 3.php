    ...
    <div class="card shadow border-0">
        <div class="card-body p-4 p-md-5">
            ...
            <div class="step" id="step1">
                ...
                <button type="button" <?= $step == 1 ? '' : 'd-none' ?>" class="btn btn-primary next-step">Next</button>
            ...
            <div class="step d-none" id="step2">
                            ...
                            <select id="classSelect" class="form-select">
                                ...
                                <?php foreach ($classes as $classId => $class): ?>
                                    <option
                                        ...
                                        <?= htmlspecialchars($class['class_name']) . '-' . htmlspecialchars($class['course_name']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                ...
                <button type="button" <?= $step == 2 ? '' : 'd-none' ?>" class="btn btn-primary next-step">Next</button>
            ...
            <div class="step d-none" id="step3">
                ...
                <div class="mt-4">
                    <button type="button" class="btn btn-secondary prev-step">Back</button>
                    <button id="finalSubmit" type="submit" class="btn btn-success">Register</button>
                </div>
    ...
    <script>
        ...
        `;
            ...
            btn.addEventListener("click", async (e) => {
                ...
                btn.disabled = true;
                try {
                    await submitStep(3); // 🔥 IMPORTANT
                    alert("Student registered successfully!");
                    window.location.href = "<?= BASE_URL ?>/admin/register.php?success=1";
                } catch (err) {
                    console.error(err);
