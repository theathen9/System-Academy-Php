<?php
session_start();
require_once "./data/dbShemaData.php"; // includes $conn and all CRUD functions
...
// Sidebar menu
$staticShemaData = [
    ["title"=>"Dashboard","link"=>"#","icon"=>"bi bi-house","active"=>true],
    ["title"=>"Students","submenu_id"=>"studentsMenu","submenu"=>[
        ["title"=>"Add Student","link"=>"#","active"=>false],
        ["title"=>"All Students","link"=>"#","active"=>true]
    ],"active"=>true],
    ["title"=>"Employees","submenu_id"=>"employeesMenu","submenu"=>[
        ["title"=>"Add Employee","link"=>"#","active"=>false],
        ["title"=>"All Employees","link"=>"#","active"=>true]
    ],"active"=>false],
    ["title"=>"Courses","link"=>"#","icon"=>"bi bi-book","active"=>false],
    ["title"=>"Departments","link"=>"#","icon"=>"bi bi-building","active"=>false],
    ["title"=>"Rooms","link"=>"#","icon"=>"bi bi-door-open","active"=>false],
    ["title"=>"Enrollments","link"=>"#","icon"=>"bi bi-journal-check","active"=>false]
];
            ...
            <div class="bg-white shadow rounded p-3 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#employeeModal">Add</button>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-3" id="paginationEmployees"></div>
            </div>

            <!-- You can add similar blocks for Students, Courses, Departments, Rooms, Enrollments -->
        </div>
    </main>
</div>
        ...
        <div class="modal-content">
            <form id="employeeForm">
                ...
                <div class="modal-body">
                    <!-- Input fields -->
                    <div class="mb-3"><label>Employee ID</label><input type="text" name="emp_id" class="form-control" required></div>
                    <div class="mb-3"><label>Name Kh</label><input type="text" name="name_kh" class="form-control" required></div>
                    <div class="mb-3"><label>Name Eng</label><input type="text" name="name_eng" class="form-control" required></div>
...
const pagination = document.getElementById('paginationEmployees');
let currentPage = 1;
...
// AJAX Add/Edit Employee
document.getElementById('employeeForm').addEventListener('submit', function(e){
    e.preventDefault();
    const data = new FormData(this);
    fetch('employee_action.php',{method:'POST',body:data})
    .then(res=>res.json())
    .then(res=>{
