...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ' . BASE_URL . '/admin/register.php?success=1');
    exit;
}
//     var_dump($_SESSION);
// var_dump($_COOKIE);
...
if (is_array($getClass)) {
    foreach ($getClass as $classRow) {
        ...
        $course = $courseCRUD->find($classRow['course_id']);
        ...
        $subject = $subjectCRUD->find($classRow['subject_id']); // ✅ correct
...
<body class="container-fluid p-0 overflow-x-hidden">
    <div class="row g-3">
        ...
        <?php Nabar($infoSchemaData, $staticSchemaData); ?>
        <!-- Main area -->
                    ...
                    <div class="w-100 ">
                        ...
                        <div id="studentSection">
                            <form id="studentForm" method="post" enctype="multipart/form-data">
                                ...
                                <!-- <input type="hidden" name="step" id="step" value="<?= $_POST['step'] ?? 1 ?>"> -->
